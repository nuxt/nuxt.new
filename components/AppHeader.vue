...
v-model="open" side="left"
    ...
    <UContainer class="flex justify-between items-center w-full">
      ...
      <div class="hidden sm:flex items-center sm:gap-x-4 text-white font-medium">
        <UButton
class="flex items-center sm:-mr-2" to="https://discord.com/invite/nuxt" target="_blank" variant="link"
        ...
        <UButton
to="http://www.github.com/nuxt/nuxt" class="flex gap-x-2 items-center" variant="link" color="gray"
