<template>
  <div class="relative group *:not-first:!my-0 *:not-first:!static my-5">
    ...
    >
      <div
        class="absolute left-0 inset-y-2 w-(--tabs-indicator-size) translate-x-(--tabs-indicator-position) transition-[translate,width] duration-200 bg-gray-700 rounded-md shadow-xs"
        :style="{
      ...
      <button
        ...
        @mouseenter="updateTabIndicator(index)"
      >
        <UIcon
          :name="manager.icon"
